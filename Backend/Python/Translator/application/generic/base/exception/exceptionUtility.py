...
class ExceptionUtility:
    ...
    def create_exception_detail(error_code, user_message, error_message, exception_type):
        ...
        elif exception_type == SessionAuthenticationException.__name__ :
            app_exception = SessionAuthenticationException()
        elif exception_type == BadRequestException.__name__:
            app_exception = BadRequestException()
        elif exception_type == SerializerValidationException.__name__:
            app_exception = SerializerValidationException()
        ...
        elif exception_type == AWSTranslateServiceException.__name__:
            app_exception = AWSTranslateServiceException()
        else:
