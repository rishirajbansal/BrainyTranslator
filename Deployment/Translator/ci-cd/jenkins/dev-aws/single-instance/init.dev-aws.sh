...
# Environment Setup Script - Copying files to appropriate directory in AWS Instances
...
cp -r ${WORKSPACE}/Deployment/Translator/ci-cd/jenkins/dev-aws/single-instance/. ${WORKSPACE}/deployment/ci-cd/
