...
#-> Command: ./db2-instance.sh AWS_DB_INSTANCE_DNS=ip-10-11-3-45.ec2.internal CONTAINER_NAME=translator-db DB_DOCKERFILE=Dockerfile.db DB_IMAGE_TAG=translator-db:1.0 BUILD_CONTEXT=. DB_CONTAINER_NAME=translator-db DOCKER_OVERLAY_NETWORK=translator-net 
